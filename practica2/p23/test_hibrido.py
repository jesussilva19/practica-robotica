...
from main_neat_avoid_232 import RoboboNEATAvoidEnv23  # entorno AE
from main_ppo import RoboboEnv # entorno AR 

# ============================================================
# CONFIG
# ============================================================

GENOME_PATH = "practica2/2.3/neat_logs_2.3.2/definitivo/models/best_genome_extracted.pkl"
...
def plot_hybrid_trajectories(all_trajectories, goal_position=None, 
    ...
    # Guardar
    output_path = './practica2/2.3/best_genome_trayectories.png'
    plt.tight_layout()
...
def main():
    ...
    background_img = './practica2/2.3/entorno3.png' 
